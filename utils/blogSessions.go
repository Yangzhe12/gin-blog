...
import (
	...
	contribSession "github.com/gin-contrib/sessions"
...
type Store interface {
	sessions.Store
	Options(contribSession.Options)
}
...
func (s *session) Options(options contribSession.Options) {
